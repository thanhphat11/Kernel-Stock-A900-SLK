...
// block and remove Phantom feature beacuse of final release
/*
...
#define FEATURE_LGU_CP_GPS_TEST_SUPPORT
#define FEATURE_LGU_CP_GPS_XTRA_DL
#define FEATURE_LGU_CP_GPS_XTRA_DL_TIME
#define FEATURE_LGU_CP_GPS_NMEA_WRITE

//These are for modem
#define FEATURE_LGU_CP_GPS_NETWORK_INFO
#define FEATURE_LGU_CP_GPS_SUPL
#define FEATURE_LGU_CP_GPS_BLOCK_GPS_IN_E911_CALL

//These are for linux
#define FEATURE_LGU_CP_GPS_FIX_FAIL
#define FEATURE_LGU_CP_GPS_GPSON
#define FEATURE_LGU_CP_GPS_PRELOAD_APP_BLOCK
